   ...
   if(TYPMOD==3 || TYPMOD==0)
	{
	 ...
	 else if((DAUDB && c3=='1') || c3=='/' ) sx=UNISS(str1,'1')
...
function keyDownInit(key)
{
  ...
  if(key==120 || key==123 || key==119) statusMessage()
}
...
function statusMessage()
{
  ...
  str += "  [F8=kiem tra chinh ta; F9=doi kieu go; F12=tat/bat bo go;]"
