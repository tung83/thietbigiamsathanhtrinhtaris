...

{
...

	{
		...
		$sInsert="insert into slider(title,sum,lnk,active,ind) values('$caption',";

		$sInsert.="'$sum','$lnk',$active,$ind)";
...

		{
			...
			imageRex(1500,450,$_FILES["files"]["tmp_name"],myPath.$fileName)	;

			mysql_query("update slider set img='".$fileName."' where id=$recent");
...

	{
		...
		$sql="select * from slider where id=".$_POST["idLoad"];
...

	{
		...
		$sUpdate="update slider set title='$caption',sum='$sum'";
...

	{
		...
		$sDelete="delete from slider where id=".$_POST["idLoad"];
	...
	$s="select * from slider order by ind asc,id desc";
	...
	$str.="<tr><td colspan=\"8\" align=\"center\" style=\"padding:5px\">
				...
				&ensp;".adminPaging(10,$count,"main.php?cnht=slider&")."</td></tr>";
	...
	$str.='<tr>
				...
				<td width="120" style="font-weight:bold">Trích dẫn(*):</td>

				<td >

					<textarea name="sum" class="txtBox">'.$rowEdit->sum.'</textarea>
	...
	$str.='<tr>
				...
				<br/><i style="font-weight:normal">Size hình 1500x450</i></td>
