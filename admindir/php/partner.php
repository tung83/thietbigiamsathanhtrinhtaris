...

{
...

	{
		...
		$sInsert="insert into partner(title,lnk,active,ind,dates) values('$caption'";
...

		{
			...
			imageRex(400,300,$_FILES["files"]["tmp_name"],myPath.$fileName)	;

			mysql_query("update partner set img='".$fileName."' where id=$recent");
...

	{
		...
		$sql="select * from partner where id=".$_POST["idLoad"];
...

	{
		...
		$sUpdate="update partner set title='$caption'";
...

	{
		...
		$sDelete="delete from partner where id=".$_POST["idLoad"];
	...
	$str.="<tr><td colspan=\"11\" class=\"headTitle\">Thông tin quản lý đối tác</td></tr>";
	...
	$s="select * from partner order by ind asc,id desc";
	...
	$str.="<tr><td colspan=\"8\" align=\"center\" style=\"padding:5px\">
				...
				&ensp;".adminPaging(10,$count,"main.php?cnht=partner&")."</td></tr>";
	...
	$str.='<tr>
				...
				<br/><i style="font-weight:normal">Size hình 400,300</i></td>
