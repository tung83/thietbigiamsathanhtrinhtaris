...
class layer_slider{
    ...
    function output(){
        ...
        foreach($list as $item){
            ...
            if(trim($item['title'])!=''){
                $str.='
                <p class="ls-l title" style="top:100px;left:60px" data-ls="offsetxin:0;durationin:2500;delayin:2000;rotateyin:90;transformoriginin:left 50% 0;offsetxout:0;rotateyout:-90;transformoriginout:left 50% 0;">
                '.$item['title'].'
                </p>';
            }
            if(trim($item['sum'])!=''){
                $str.='
                <p class="ls-l" style="max-width:800px;top:170px;left:60px;font-size:20px;line-height:28px;color:#fff;background:rgba(0,0,0,0.5);padding:10px" data-ls="offsetxin:0;durationin:2000;delayin:3500;">
